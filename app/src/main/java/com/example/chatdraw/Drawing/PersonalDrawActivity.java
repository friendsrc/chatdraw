...
public class PersonalDrawActivity extends AppCompatActivity implements ColorPickerDialogListener {

  private static final String TAG = "PersonalDrawActivity";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_personal_draw);
    ...
    mColorButton.setOnClickListener(v -> {
      ...
      mColorPickerDialog
          ...
          .show(PersonalDrawActivity.this);
    });
    ...
    switch (item.getItemId()) {
      case R.id.draw_undo:
        if (mCanvasView.isEveryoneVisible()) {
          ...
          Toast.makeText(PersonalDrawActivity.this,
