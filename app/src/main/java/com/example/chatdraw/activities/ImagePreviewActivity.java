...
public class ImagePreviewActivity extends AppCompatActivity {
  ...
  /**
   * Save the image to the device's interal storage.
   * @param imageUrl url of the image to be saved
   */
    ...
    Picasso.get().load(imageUrl).into(new Target() {
      ...
      public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
        ...
        if (ContextCompat.checkSelfPermission(ImagePreviewActivity.this,
          ...
          insertImage(
              getContentResolver(),
              ImagePreviewActivity.this.bitmap,
              name,
              "Sent by " + senderName
          );
  ...
  /**
   * Uh yes.
   * @param cr contentresoulver
   * @param source bitmap to be saved
