...
public class GroupInfoEditActivity extends AppCompatActivity {
  ...
  private void selectImage() {
    ...
    builder.setItems(items, (dialogInterface, i) -> {
      if (items[i].equals("Camera")) {
        ...
        if (ContextCompat
            .checkSelfPermission(GroupInfoEditActivity.this, Manifest.permission.CAMERA)
        ...
        if (ContextCompat
            .checkSelfPermission(GroupInfoEditActivity.this, Manifest.permission.CAMERA)
            == PackageManager.PERMISSION_DENIED) {
          Toast.makeText(GroupInfoEditActivity.this, "Camera permission not granted",
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    if (resultCode == Activity.RESULT_OK) {
      ...
      if (selectedImageUri != null) {
        final StorageReference fileReference = mStorageRef.child(groupId).child("newGroupPic")
            .child("image.jpg");
        ...
        uploadTask.addOnFailureListener(e -> {
          ...
          Toast.makeText(GroupInfoEditActivity.this, e.getMessage(),
              Toast.LENGTH_SHORT).show();
        }).addOnSuccessListener(taskSnapshot -> {
          mProgressDialog.dismiss();
          Toast.makeText(GroupInfoEditActivity.this, "Upload successful",
        ...
        final StorageReference imageRef =
            fileReference.child(groupId).child("newGroupPic").child("image.jpg");
  ...
  private void sendMessage() {
    ...
    GoogleSignInAccount acct =
        GoogleSignIn.getLastSignedInAccount(GroupInfoEditActivity.this);
    if (acct != null) {
      userUid = acct.getId();
    } else {
          ...
          public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            if (isNameChanged || isPhotoChanged) {
              ...
              ChatItem chatItem  = new ChatItem(
                  userUid + "\tINFO\t" + message, userUid, name, username, imageUrl,
              ...
              db.collection("GroupMessages")
                  ...
                  .add(chatItem);
              Toast.makeText(GroupInfoEditActivity.this, "Changes saved.",
                  Toast.LENGTH_SHORT).show();
            }
            finish();
          }
